...
//
//				CharacterManager::GetInstance()->m_character[0]->m_transform.SetPosition(Vec3(14.f, 0.0f, -165.f));
//				CharacterManager::GetInstance()->m_character[1]->m_transform.SetPosition(Vec3(18.f, 0.f, -160.f));
//				CharacterManager::GetInstance()->m_character[2]->m_transform.SetPosition(Vec3(22.f, 0.f, -155.f));
//				CharacterManager::GetInstance()->m_character[3]->m_transform.SetPosition(Vec3(26.f, 0.f, -150.f));
//
//			}
//
...
//
//				CharacterManager::GetInstance()->m_character[0]->m_transform.SetPosition(Vec3(17.f, 0.f, -110.5f));
//				CharacterManager::GetInstance()->m_character[1]->m_transform.SetPosition(Vec3(25.f, 0.f, -105.5f));
//				CharacterManager::GetInstance()->m_character[2]->m_transform.SetPosition(Vec3(33.f, 0.f, -100.5f));
//				CharacterManager::GetInstance()->m_character[3]->m_transform.SetPosition(Vec3(41.f, 0.f, -95.5f));
//
//			}
//
//		}
...
//			//			//1フレーム前の座標に戻して進行方向とは
//			//			//逆のベクトルを足し込む
//			//			Vec3 reverse = CharacterManager::GetInstance()->m_character[i]->m_transform.GetPosition() - CharacterManager::GetInstance()->m_character[t]->m_transform.GetPosition();
...
//
//			const Vec3 color = RaceManager::GetInstance()->m_course->m_backgroundColor;
